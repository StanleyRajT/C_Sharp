...
namespace Vaccination
{
    ...
    class Program
    {
        ...
        /// <summary>
        /// HomePage method shows home page
        /// </summary>
        ...
        /// <summary>
        /// AddBeneficiaryDetails method helps to creates new beneficiary and adds to the list
        /// </summary>
        /// <param name="dose"></param>
        private static void AddBeneficiaryDetails()
        {
            Console.WriteLine("-------------------------------------------");
        ...
        //VaccinationProcess method helps to initiate Vaccination menu
        private static void VaccinationProcess()
        {
            ...
            do
            {
                ...
                {
                    Console.WriteLine("Incorrect registration number.\nEnter 1 to Re-enter your Registraion number. (OR)\nSelect 2 to Goback to main menu.");
                    int reEnterChoice = int.Parse(Console.ReadLine());
                    if (reEnterChoice == 2)
                    {
                        flag = false;
                    }
        ...
        /// <summary>
        /// TakeVaccination method helps to take vaccination
        /// </summary>
        ...
        private static void TakeVaccination(BeneficiaryDetails currentBeneficiary)
        {
            ...
            do
            {
                ...
                if (currentBeneficiary.VaccinatedDetails.Count == 0)
                {
                ...
                {
                    if ((VaccineType)vaccineType == currentBeneficiary.VaccinatedDetails[0].Vaccine)
                    {
                        Console.WriteLine("Enter Date in dd/mm/yyyy");
                        string enteredDate = Console.ReadLine();
                        string[] splitDate = enteredDate.Split("/");
                ...
                {
                    Console.WriteLine("you had your both dosages");
                    break;
                }
        ...
        /// <summary>
        /// VaccinationHistory method shows the vaccination history
        /// </summary>
        /// <param name="currentBeneficiary"></param>
        private static void VaccinationHistory(BeneficiaryDetails currentBeneficiary)
        {
            ...
            if (currentBeneficiary.VaccinatedDetails.Count == 0)
            {
                Console.WriteLine("Please take your Vaccination first!!!");
            }


        }
        /// <summary>
        /// ShowListOfBeneficiary method shows the list of all beneficiaries
        /// </summary>
